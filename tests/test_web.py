...
def test_submit_form(client):
    ...
    post_response = client.post('/', data={'url': 'example.com', 'csrf_token': csrf_token})
...
def test_results_page_spf_record(client):
    ...
    assert b"Vulnerable" in post_response.data or b"Valid" in post_response.data or b"Invalid" in post_response.data
